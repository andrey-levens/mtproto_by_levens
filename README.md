...
Тестировалось на: последней версии клиента Telegram на 20.05.26, сервер на Debian 12.

Установка: 

🇬🇧 A script that quickly installs a Telegram proxy on your server. It works even with the XRay client enabled.

Tested on: latest version of the Telegram client (May 20, 2026), server running Debian 12.
